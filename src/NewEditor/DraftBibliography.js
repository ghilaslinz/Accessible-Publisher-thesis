...
export const onAddLink = (
 ...
 // let newState = EditorSate.push(editorState, textWithEntity, "insert-characters");
...
const Draft = (props) => {
  ...
  const [selectedBibliographyNumber, setSelectedBibliographyNumber] =
    useState(null);
  const [footnote, setFootnote] = useState("");
  const [getbibliography, setgetBibliography] = useState("");
  ...
  const handleSubmit = (e) => {
    ...
    if (selectedBibliographyNumber) {
      console.log("here");
      console.log(selectedBibliographyNumber);
      const entityKey = onAddLink(
        editorState,
        setEditorState,
        selectedBibliographyNumber,
        `${time}`,
        props.id,
        props.handleChangeEditorState
      );
      const newBibliography = {
        ...
        //   id: count,
        text: bibliography,
        number: selectedBibliographyNumber,
        // completed: false,
        entityKey,
        editorId: props.id,
      };
      ...
      setSelectedBibliographyNumber(null);
      setBibliography("");
    } else {
      const entityKey = onAddLink(
        editorState,
      ...
      <>
        <EditorStyled>
          <Editor
            ...
            toolbar={{
              options: ['inline', 'list', 'blockType', 'history','link'],
              inline: {
                inDropdown: false,
                className: undefined,
                component: undefined,
        ...
        >
          <DialogTitle id="form-dialog-title">Reference</DialogTitle>
          <DialogContent>
            ...
            <TextField
             ...
             // type="email"
              ...
              //  setgetBibliography
              value={bibliography}
              //value={getbibliography}
              sx={{ mt: 2, minWidth: 500 }}
            />

            <ol>
              {props.bibliographys.map((bibliography) => (
                    ...
                    <li key={bibliography.key} id={bibliography.id}>
                      <List>
                        <ListItem disablePadding>
                          <ListItemButton>
                            <ListItemText
                              primary={bibliography.text}
                              onClick={() => {
                                setBibliography(bibliography.text);
                                setSelectedBibliographyNumber(
                                  bibliography.number
                                );
                              }}
                            />
        ...
        <Dialog
          fullScreen={fullScreen}
          open={openfoot}
          onClose={handleCloseFoot}
          aria-labelledby="form-dialog-title"
        >
          <DialogTitle id="form-dialog-title">Footnote</DialogTitle>
          <DialogContent>
            <DialogContentText>Write your foot note here</DialogContentText>
            <TextField
              autoFocus
              margin="dense"
              multiline
          ...
          <DialogActions>
            <Button onClick={handleCloseFoot} color="primary">
              Cancel
            </Button>
            <Button onClick={handleSubmitFoot} color="primary">
              Add
            </Button>
          </DialogActions>
        </Dialog>
